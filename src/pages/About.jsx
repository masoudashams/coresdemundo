...
function About() {
  return (
    <> 
      ...
      <div  className="bg-about  bg-gradient-to-t from-transparent to-zinc-900">
        <div className='absolute flex flex-col items-center text-center mx-50 text-white m-8'>
        ...
        It has roots in a piece of classical Latin literature from 45 BC,
         ...
         classical literature, discovered the undoubtable source. Lorem Ipsum comes from sections
          ...
          Renaissance. The first line of Lorem Ipsum, "Lorem ipsum dolor sit amet..", comes from a line
           ...
           <div  className="bg-about2  bg-gradient-to-t from-transparent to-zinc-900">
        <div className='absolute flex flex-col items-center text-center mx-50 text-white m-8'>
